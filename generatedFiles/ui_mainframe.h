...
public:
    ...
    QAction *action_ContactTest;
    QAction *actionBodyDescriptor;
    QAction *action_PointOnFace;
    QAction *action_FaceTrait;
    QAction *action_PartIso;
    QAction *action_DBGTime;
    ...
    QAction *action_VoxelGeneration;
    QAction *action_HideDisassembled;
    QAction *action_ShowFullProduct;
    QWidget *mainwidget;
    ...
    void setupUi(QMainWindow *MainFrame)
    {
        ...
        action_ContactTest = new QAction(MainFrame);
        action_ContactTest->setObjectName(QString::fromUtf8("action_ContactTest"));
        action_ContactTest->setCheckable(false);
        actionBodyDescriptor = new QAction(MainFrame);
        actionBodyDescriptor->setObjectName(QString::fromUtf8("actionBodyDescriptor"));
        action_PointOnFace = new QAction(MainFrame);
        action_PointOnFace->setObjectName(QString::fromUtf8("action_PointOnFace"));
        action_FaceTrait = new QAction(MainFrame);
        action_FaceTrait->setObjectName(QString::fromUtf8("action_FaceTrait"));
        action_PartIso = new QAction(MainFrame);
        action_PartIso->setObjectName(QString::fromUtf8("action_PartIso"));
        action_DBGTime = new QAction(MainFrame);
        action_DBGTime->setObjectName(QString::fromUtf8("action_DBGTime"));
        ...
        action_VoxelGeneration = new QAction(MainFrame);
        action_VoxelGeneration->setObjectName(QString::fromUtf8("action_VoxelGeneration"));
        action_HideDisassembled = new QAction(MainFrame);
        action_HideDisassembled->setObjectName(QString::fromUtf8("action_HideDisassembled"));
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/emptyAsmState.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_HideDisassembled->setIcon(icon13);
        action_ShowFullProduct = new QAction(MainFrame);
        action_ShowFullProduct->setObjectName(QString::fromUtf8("action_ShowFullProduct"));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/fullAssemblyState.png"), QSize(), QIcon::Normal, QIcon::Off);
        action_ShowFullProduct->setIcon(icon14);
        ...
        menubar->setGeometry(QRect(0, 0, 997, 31));
        ...
        MainFrame->insertToolBarBreak(TestFunction);
        ...
        AsmPlaneBar->addAction(action_ShowFullProduct);
        ...
        AsmPlaneBar->addAction(action_HideDisassembled);
        AsmPlaneBar->addAction(actionDBGShow);
        AsmPlaneBar->addAction(actionFoto);
        TestFunction->addAction(action_DBGTime);
        TestFunction->addAction(action_VoxelGeneration);
        TestFunction->addAction(actionViewMode);
        TestFunction->addAction(action_FaceTrait);
        TestFunction->addAction(action_PartIso);
        TestFunction->addAction(actionBodyDescriptor);
        TestFunction->addAction(actionPartGraph);
        TestFunction->addAction(action_ContactTest);
        TestFunction->addAction(action_PointOnFace);
    ...
    void retranslateUi(QMainWindow *MainFrame)
    {
        ...
        action_ContactTest->setText(QApplication::translate("MainFrame", "Contacts", 0, QApplication::UnicodeUTF8));
        action_ContactTest->setIconText(QApplication::translate("MainFrame", "Contacts", 0, QApplication::UnicodeUTF8));
        actionBodyDescriptor->setText(QApplication::translate("MainFrame", "BodyDesc", 0, QApplication::UnicodeUTF8));
        action_PointOnFace->setText(QApplication::translate("MainFrame", "T2", 0, QApplication::UnicodeUTF8));
        action_PointOnFace->setIconText(QApplication::translate("MainFrame", "PointsOnFaces", 0, QApplication::UnicodeUTF8));
        action_FaceTrait->setText(QApplication::translate("MainFrame", "T3", 0, QApplication::UnicodeUTF8));
        action_FaceTrait->setIconText(QApplication::translate("MainFrame", "FaceTrait", 0, QApplication::UnicodeUTF8));
        action_PartIso->setText(QApplication::translate("MainFrame", "T4", 0, QApplication::UnicodeUTF8));
        action_PartIso->setIconText(QApplication::translate("MainFrame", "ToPartIso", 0, QApplication::UnicodeUTF8));
        action_DBGTime->setText(QApplication::translate("MainFrame", "T5", 0, QApplication::UnicodeUTF8));
        action_DBGTime->setIconText(QApplication::translate("MainFrame", "DBGTime", 0, QApplication::UnicodeUTF8));
        ...
        action_VoxelGeneration->setText(QApplication::translate("MainFrame", "Voxel", 0, QApplication::UnicodeUTF8));
        action_HideDisassembled->setText(QApplication::translate("MainFrame", "E", 0, QApplication::UnicodeUTF8));
        action_ShowFullProduct->setText(QApplication::translate("MainFrame", "F", 0, QApplication::UnicodeUTF8));
