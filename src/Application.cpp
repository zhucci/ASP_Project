    ...
    : QMainWindow( 0 )
{
	...
	connect(actionSTEPFile,SIGNAL(triggered()),this,SLOT(OnImportStep()));
	
	connect(actionNextStep,SIGNAL(triggered()),this,SLOT(box()));
	connect(actionStop,SIGNAL(triggered()),this,SLOT(cylinder()));
